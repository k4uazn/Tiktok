  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-md mx-auto">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h1 className="text-lg font-semibold flex-1 text-center pr-6">
              {showPixForm ? "Vincular PIX" : "Reembolsos de reservas"}
            </h1>
          </div>
      ...
      <div className="max-w-md mx-auto px-4 py-4">
        ...
        {/* PIX Form - Slides up from bottom */}
        <div 
          className={`bg-card rounded-xl shadow-md mt-4 transition-all duration-300 ease-out overflow-hidden ${
            showPixForm 
              ? "opacity-100 translate-y-0 max-h-[600px] p-6" 
              : "opacity-0 translate-y-8 max-h-0 p-0"
          }`}
        >
          {/* Nome Input */}
          <div className="mb-6">
