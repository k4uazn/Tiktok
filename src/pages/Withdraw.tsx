...
const Withdraw = () => {
  ...
  const handleSubmit = () => {
    ...
    if (isNomeValid && isPixValid) {
      ...
      console.log("Vinculando PIX:", { nome, pixKeyType, pixKey });
      navigate("/");
    }
  };
          ...
          <div className="space-y-4">
            ...
            <div className="bg-card rounded-xl shadow-md">
              <button
                ...
                className="w-full p-4 flex items-center justify-between hover:bg-secondary/50 transition-colors rounded-xl"
              >
